...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center py-10 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 lg:p-16 border border-white/20 flex flex-col items-center relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 w-full">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mt-8 gap-4 pt-6 border-t border-white/10">
      ...
      <style jsx>{`
        ...
        .service-card {
          @apply flex items-center gap-4 bg-white/5 rounded-xl px-5 py-4 cursor-pointer transition-all duration-300 border backdrop-blur-sm relative overflow-hidden;
        }
        
        .service-card::before {
          content: '';
          @apply absolute inset-0 bg-gradient-to-r from-blue-500/0 via-purple-500/0 to-pink-500/0 transition-all duration-300;
        }
        
        .service-card:hover::before {
          @apply from-blue-500/10 via-purple-500/10 to-pink-500/10;
        }
        
        .service-card-default {
          @apply border-white/10 hover:border-purple-500/50 hover:bg-white/10;
        }
        
        .service-card-selected {
          @apply border-purple-500/50 bg-purple-500/10 shadow-lg scale-[1.02];
        }

        .service-card-selected::before {
          @apply from-blue-500/20 via-purple-500/20 to-pink-500/20;
        }
        ...
        .service-text {
          @apply text-white/90 text-lg font-medium block mb-1;
        }
