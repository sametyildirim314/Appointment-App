                  ...
                  <div className="services-list">
                    ...
                    <ul>
                      {appointment.selectedServices && appointment.selectedServices.map((service, index) => (
                        <li key={index}>
                          {typeof service === 'object' ? service.name : service} - {typeof service === 'object' ? service.price : ''} TL
                        </li>
                      ))}
                    </ul>
                    <p className="total-price">
                      <strong>Toplam:</strong> {appointment.selectedServices && appointment.selectedServices.reduce((sum, service) => {
