...
function Admin() {
  ...
  const services = [
    { id: "Saç Kesimi", name: 'Saç Kesimi', price: 400 },
    { id: "Saç Boyama", name: 'Saç Boyama', price: 500 },
    { id: "Sakal Traşı", name: 'Sakal Traşı', price: 100 },
    { id: "Saç Yıkama", name: 'Saç Yıkama', price: 100 },
    { id: "Saç Bakımı", name: 'Saç Bakımı', price: 300 },
     { id: "Bahşiş", name: 'Saç Bakımı', price: 300 }
  ];
              ...
              <div className="appointment-info">
                ...
                <div className="appointment-details">
                  ...
                  <div className="services-list">
                    ...
                    <ul>
                      {appointment.selectedServices && appointment.selectedServices.map((serviceId, index) => {
                        const service = services.find(s => s.name === serviceId);
                        return (
                          <li key={serviceId}>
                            {service ? service.name : 'Bilinmeyen Hizmet'} - {service ? service.price : 0} TL
                          </li>
                        );
                      })}
                    </ul>
                    <p className="total-price">
                      <strong>Toplam:</strong> {appointment.selectedServices ? calculateTotalPrice(appointment.selectedServices) : 0} TL
                    </p>
                  </div>
