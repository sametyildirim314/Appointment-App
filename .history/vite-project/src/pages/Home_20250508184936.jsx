  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center py-10 px-4 relative overflow-hidden">
      ...
      <style jsx>{`
        ...
        .service-card {
          @apply flex items-center gap-4 bg-white/5 rounded-xl px-5 py-4 cursor-pointer transition-all duration-300 border backdrop-blur-sm;
        }
        ...
        .service-checkbox {
          @apply accent-purple-500 w-5 h-5;
        }
        ...
        .service-price {
          @apply text-purple-400 font-semibold ml-2;
        }
