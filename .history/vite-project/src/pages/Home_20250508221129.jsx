...
const Home = () => {
  ...
  const services = [
    ...
    { id: 3, name: 'Sakal Traşı', price: 40 },
    { id: 4, name: 'Saç Yıkama', price: 30 },
    { id: 5, name: 'Saç Bakımı', price: 60 }
  ];
    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center py-10 px-4 relative overflow-hidden">
      ...
      <style jsx>{`
        ...
        .services-table-container {
          @apply overflow-x-auto rounded-xl border border-white/10 backdrop-blur-sm;
        }
        ...
        .services-table th {
          @apply px-6 py-4 text-left text-sm font-semibold text-white/70 uppercase tracking-wider;
        }
        ...
        .service-row {
          @apply transition-all duration-300 border-b border-white/5;
        }
