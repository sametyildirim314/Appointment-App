...
function Admin() {
  ...
  const [searchTerm, setSearchTerm] = useState('Randevu ara');
    ...
    <div className="container">
      ...
      <div className="search-container">
        <input
          ...
          onFocus={() => searchTerm === 'Randevu ara' && setSearchTerm('')}
          onBlur={() => !searchTerm && setSearchTerm('Randevu ara')}
      ...
      <div className="appointments-list">
        ...
        {loading ? (
          ...
          <div className="no-appointments">
            {searchTerm === 'Randevu ara' ? 'Filtrelere uygun randevu bulunamadı.' : 'Henüz randevu bulunmamaktadır.'}
          </div>
        ) : (
