  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">Randevu Al</h1>
        {message && <div className="text-center text-green-500 mb-4">{message}</div>}
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label className="block text-gray-700 font-semibold mb-2">İsim</label>
            <input
              type="text"
              value={formData.name}
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-semibold mb-2">Saat</label>
            <input
              type="time"
              value={formData.time}
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-semibold mb-2">Notlar</label>
            <textarea
          ...
          <div className="mb-4">
            <strong className="text-lg">Toplam Fiyat: {totalPrice} TL</strong>
          </div>
