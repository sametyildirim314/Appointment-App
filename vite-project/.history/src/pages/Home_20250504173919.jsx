...
const SERVICES = [
  ...
  { id: 2, name: 'Saç Boyama', price: 250 },
  { id: 3, name: 'Saç Bakımı', price: 150 },
  { id: 4, name: 'Sakal Tıraşı', price: 50 },
  { id: 5, name: 'Saç Yıkama', price: 30 },
  ...
  return (
    <div className="container">
      ...
      <div className="info-section">
        ...
        <p>Randevunuza gelemeyecek olursanız lütfen en geç 1 saat kala bizimle iletişime geçiniz!</p>
